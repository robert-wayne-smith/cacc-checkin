...
{
    /// <summary>
    /// Interaction logic for MOPSCheckInView.xaml
    /// </summary>
    public partial class MOPSCheckInView : UserControl, IMOPSCheckInView
    {
        private static readonly ILog logger = LogManager.GetLogger(MethodBase.GetCurrentMethod().DeclaringType);

        private MOPSCheckInPresenter _presenter;
        ...
        public const string ViewName = "MOPSCheckInView";

        public MOPSCheckInView()
        {
            InitializeComponent();
        }

        /// <summary>
        /// The constructor for the MOPSCheckInView. Wires up all the necessary
        /// objects and events needed by this View.
        /// </summary>
        /// <param name="presenter"></param>
        /// <param name="eventAggregator"></param>
        /// <param name="configurationService"></param>
        public MOPSCheckInView(MOPSCheckInPresenter presenter, IEventAggregator eventAggregator,
        ...
        private void UserControl_Loaded(object sender, RoutedEventArgs e)
        {
            try
            {
                ...
                UpdateShellStatusBar("MOPS check-in view loaded.");
            }
            catch (Exception ex)
            {
        ...
        #region IMOPSCheckInView Members
