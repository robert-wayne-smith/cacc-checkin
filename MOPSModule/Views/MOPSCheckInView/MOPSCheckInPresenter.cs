...
{
    public class MOPSCheckInPresenter
    {
        private static readonly ILog logger = LogManager.GetLogger(MethodBase.GetCurrentMethod().DeclaringType);

        private IEventAggregator _eventAggregator;
        private readonly ILabelPrinterService _labelPrinterService;
        private const string TargetDepartment = Departments.MOPS;

        #region Properties

        public IMOPSCheckInView View { get; set; }
        ...
        /// <summary>
        /// Constructor for MOPSCheckInPresenter
        /// </summary>
        /// <param name="eventAggregator"></param>
        /// <param name="labelPrinterService"></param>
        public MOPSCheckInPresenter(IEventAggregator eventAggregator,
            ILabelPrinterService labelPrinterService)
        {
            logger.DebugFormat("Creating MOPSCheckInPresenter.");
        ...
        /// only get members in Adult or MOPS departments.
        /// </summary>
        /// <param name="person"></param>
