...
namespace CACCCheckIn.Modules.LadiesBibleStudy.Views
{
    public class LadiesBibleStudyCheckInPresenter
    {
        private static readonly ILog logger = LogManager.GetLogger(MethodBase.GetCurrentMethod().DeclaringType);

        private IEventAggregator _eventAggregator;
        private readonly ILabelPrinterService _labelPrinterService;
        private const string TargetDepartment = Departments.LadiesBibleStudy;

        #region Properties

        public ILadiesBibleStudyCheckInView View { get; set; }
        ...
        /// <summary>
        /// Constructor for LadiesBibleStudyCheckInPresenter
        /// </summary>
        /// <param name="eventAggregator"></param>
        /// <param name="labelPrinterService"></param>
        public LadiesBibleStudyCheckInPresenter(IEventAggregator eventAggregator,
            ILabelPrinterService labelPrinterService)
        {
            logger.DebugFormat("Creating LadiesBibleStudyCheckInPresenter.");
        ...
        /// only get members in Adult or Ladies Bible Study departments.
        /// </summary>
        /// <param name="person"></param>
                ...
                View.ViewDispatcher.BeginInvoke(DispatcherPriority.DataBind,
                    new DispatcherOperationCallback(
                        delegate(object arg)
                        {
                            ...
                            // either in Adult or LadiesBibleStudy department. These are
                            // the only valid departments for Ladies Bible Study check-in 
                            ...
                            View.FamilyDataContext = people.FindAll(p => 
                                (p.DepartmentName.Equals(Departments.Adult) ||
                                 p.DepartmentName.Equals(Departments.LadiesBibleStudy)) &&
