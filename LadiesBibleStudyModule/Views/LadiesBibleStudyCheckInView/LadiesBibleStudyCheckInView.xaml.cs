...
{
    /// <summary>
    /// Interaction logic for LadiesBibleStudyCheckInView.xaml
    /// </summary>
    public partial class LadiesBibleStudyCheckInView : UserControl, ILadiesBibleStudyCheckInView
    {
        private static readonly ILog logger = LogManager.GetLogger(MethodBase.GetCurrentMethod().DeclaringType);

        private LadiesBibleStudyCheckInPresenter _presenter;
        ...
        public const string ViewName = "LadiesBibleStudyCheckInView";

        public LadiesBibleStudyCheckInView()
        {
            InitializeComponent();
        }

        /// <summary>
        /// The constructor for the LadiesBibleStudyCheckInView. Wires up all the necessary
        /// objects and events needed by this View.
        /// </summary>
        /// <param name="presenter"></param>
        /// <param name="eventAggregator"></param>
        /// <param name="configurationService"></param>
        public LadiesBibleStudyCheckInView(LadiesBibleStudyCheckInPresenter presenter, IEventAggregator eventAggregator,
        ...
        private void UserControl_Loaded(object sender, RoutedEventArgs e)
        {
            try
            {
                ...
                UpdateShellStatusBar("Ladies Bible Study check-in view loaded.");
            }
            catch (Exception ex)
            {
        ...
        #region ILadiesBibleStudyCheckInView Members
